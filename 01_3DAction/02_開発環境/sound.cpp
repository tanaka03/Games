...
{// 各音素材のパラメータ
	{ "data/SOUND/SE/Beam.wav", 0 },				// ビーム
	{ "data/SOUND/SE/Punch.wav", 0 },				// パンチ
	{ "data/SOUND/SE/Strike.wav", 0 },				// 殴り
	{ "data/SOUND/SE/Kick.wav", 0 },				// キック
	{ "data/SOUND/SE/Set.wav", 0 },					// スロットが止まった時の音
	{ "data/SOUND/SE/Roulette.wav", 0 },			// ルーレットの音
	{ "data/SOUND/SE/StatusUp.wav", 0 },			// ステータスなどが上がる音
	{ "data/SOUND/BGM/coastlands_bgm.wav", -1 }		// ステージ1BGM
};
