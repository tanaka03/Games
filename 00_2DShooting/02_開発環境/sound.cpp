...
{
	{ "data/BGM/Galaxy_in_MyHeart.wav", -1 },	// タイトルのBGM
	{ "data/BGM/In_Full_Bloom.wav", -1 },		// ゲーム中のBGM
	{ "data/BGM/Result.wav", 0 },				// リザルトのBGM
	{ "data/SE/select.wav", 0 },				// 弾発射音
	{ "data/SE/shot.wav", 0},					// 弾発射音
	{ "data/SE/Item.wav", 0 },					// アイテム音
	{ "data/SE/KO.wav", 0 },					// ボス倒した時の音
};
